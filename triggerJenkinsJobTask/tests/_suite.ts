...
describe('Trigger Jenkins Job task tests', function () {
    ...
    it('should fail with simple inputs', async () => {
        this.timeout(50000);
    ...
    it('should timeout with simple inputs', async () => {
        this.timeout(50000);
    ...
    it('should succeed with simple inputs and wait', async () => {
        this.timeout(50000);
    ...
    it('it should fail if jenkinsJobUrl is not specified', async () => {
        this.timeout(1000);
    ...
    it('it should fail if jenkinsUsername is not specified', async () => {
        this.timeout(1000);
    ...
    it('it should fail if jenkinsApiToken is not specified', async () => {
        this.timeout(1000);
    ...
    it('it should fail if authenticationToken is not specified', async () => {
        this.timeout(1000);
